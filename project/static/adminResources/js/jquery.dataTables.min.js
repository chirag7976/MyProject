...
(function(h) {
	...
	function rb(a) {
		var b = a.oClasses,
			...
			e = a.oPreviousSearch,
			f = a.aanFeatures,
			g = '<input type="search" class=" d-inline ' + b.sFilterInput + '"/>',
			j = d.sSearch,
			j = j.match(/_INPUT_/) ? j.replace('_INPUT_', g) : j + g,
			b = h('<span/>', { id: !f.f ? c + '_filter' : null, class: b.sFilter }).append(h('<label class="font-weight-bold"/>').append(j)),
			f = function() {
	...
	var m = function(a) {
			...
			this.each(function() {
				...
				if ('table' != this.nodeName.toLowerCase())
					...
					z(o, 'aoDrawCallback', g.fnDrawCallback, 'faculty');
					z(o, 'aoServerParams', g.fnServerParams, 'faculty');
					z(o, 'aoStateSaveParams', g.fnStateSaveParams, 'faculty');
					z(o, 'aoStateLoadParams', g.fnStateLoadParams, 'faculty');
					z(o, 'aoStateLoaded', g.fnStateLoaded, 'faculty');
					z(o, 'aoRowCallback', g.fnRowCallback, 'faculty');
					z(o, 'aoRowCreatedCallback', g.fnCreatedRow, 'faculty');
					z(o, 'aoHeaderCallback', g.fnHeaderCallback, 'faculty');
					z(o, 'aoFooterCallback', g.fnFooterCallback, 'faculty');
					z(o, 'aoInitComplete', g.fnInitComplete, 'faculty');
					z(o, 'aoPreDrawCallback', g.fnPreDrawCallback, 'faculty');
					o.rowIdFn = R(g.rowId);
					ib(o);
					var u = o.oClasses;
					g.bJQueryUI
	...
	h.extend(m.ext.classes, {
		...
		sPaging: 'dataTables_paginate float-right paging_',
		sLength: 'dataTables_length d-none',
